...
export default function ConciergeMock(){
  return (
    <div className="p-6 rounded-lg text-white" style={{background: `linear-gradient(180deg, rgba(10,10,10,0.9), ${brands.black})`}}>
      ...
      <div className="space-y-3">
        ...
        <div className="p-3 rounded text-white self-start" style={{backgroundColor: brands.taida}}>I need a full set Friday around 5pm</div>
