  ...
  return (
    <nav className="w-full bg-black text-white px-6 py-4 flex items-center justify-between">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-600 to-yellow-500 flex items-center justify-center text-black font-bold">👑</div>
      ...
      <div>
        <button className="bg-amber-500 text-black font-semibold px-4 py-2 rounded-full">BOOK NOW</button>
      </div>
    </nav>
  )
}
